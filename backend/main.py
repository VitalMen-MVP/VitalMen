...
from controllers import post_controller, tarefa_controller, user_controller, listas_controller, comments
...
app.register_blueprint(comments.comment_bp)  # "carrega" as rotas ligadas as listas


FRONT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'frontend'))
from models import db, User # Importe todas as classes do models aqui
# ...
